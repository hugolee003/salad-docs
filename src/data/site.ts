...
export const siteConfig: SiteConfig = {
  ...templateSiteConfig,
  name: "salad docs",
  description: "salad docs documentation",
  repoUrl: "https://github.com/hugolee003/salad-docs",
  links: [
    { label: "Get started", href: "/quickstart" },
    { label: "Support", href: "https://github.com/hugolee003/salad-docs/issues/new" },
    { label: "GitHub", href: "https://github.com/hugolee003/salad-docs" },
    { label: "Changelog", href: "/changelog" },
  ],
};
